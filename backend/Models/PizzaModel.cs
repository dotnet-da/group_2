...
namespace backend
{
    public class Pizza
    {
        ...
        public async Task<Pizza> FindOneAsync(int id_pizza)
        {
            ...
            cmd.CommandText = @"SELECT * FROM stjucloo.pizza WHERE p_id = @id_pizza;";
        ...
        {
            using var cmd = Db.Connection.CreateCommand();
            cmd.CommandText = @"SELECT * FROM stjucloo.pizza;";
        ...
        {
            using var cmd = Db.Connection.CreateCommand();
            cmd.CommandText = @"UPDATE stjucloo.pizza SET p_name = @p_name WHERE p_id = @p_id;";
            BindParams(cmd);
            BindId(cmd);
        ...
        {
            using var cmd = Db.Connection.CreateCommand();
            cmd.CommandText = @"DELETE FROM stjucloo.pizza WHERE p_id = @p_id;";
            BindId(cmd);
